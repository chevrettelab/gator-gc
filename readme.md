...
Six putative regions containing the required genes (pigC, pigG, and PigI) were identified, with a specified maximum distance between them of <86 kb (this default value can be adjusted using --required_distance. Additionally, a window extension of 10 Kb was applied (this default value can be modified using --window_extension).
